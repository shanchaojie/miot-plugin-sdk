      ...
      return (
        <View style={styles.modeBaseBack}>
          ...
          <View {...this._washwlpanResponder.panHandlers} style={styles.slideBack} pointerEvents={this.state.auto_wl == 1 ? 'none' : 'auto'}>
            <ProgressViewIOS style={styles.washSlide} progress={this.state.washwlprogress} progressTintColor={this.state.auto_wl == 1 ? '#525354' : '#37C6EE'}>
            </ProgressViewIOS>
      ...
      return (
        <View style={styles.modeBaseBack}>
          ...
          <View {...this._washpanResponder.panHandlers} style={styles.slideBack} >
            <ProgressViewIOS style={styles.washSlide} progress={this.state.washprogress} progressTintColor={'#37C6EE'}>
            </ProgressViewIOS>
      ...
      return (
        <View style={styles.modeBaseBack}>
          ...
          <View {...this._rinsepanResponder.panHandlers} style={styles.slideBack} pointerEvents={this.state.checkdirty == 1 ? 'none' : 'auto'}>
            <ProgressViewIOS style={styles.washSlide} progress={this.state.rinseprogress}
              progressTintColor={this.state.checkdirty == 1 ? '#525354' : '#37C6EE'}>
            </ProgressViewIOS>
      ...
      return (
        <View style={styles.modeBaseBack}>
          ...
          <View {...this._drierpanResponder.panHandlers} style={styles.slideBack}>
            <ProgressViewIOS style={styles.washSlide} progress={this.state.drierprogress} progressTintColor={'#37C6EE'}>
            </ProgressViewIOS>
      ...
      return (
        <View style={styles.modeBaseBack}>
          ...
          <View {...this._heatpanResponder.panHandlers} style={styles.slideBack}>
            <ProgressViewIOS style={styles.washSlide} progress={this.state.heatprogress} progressTintColor={'#37C6EE'}>
            </ProgressViewIOS>
      ...
      return (
        <View style={styles.modeBaseBack}>
          ...
          <View {...this._wateridpanResponder.panHandlers} style={styles.slideBack}>
            <ProgressViewIOS style={styles.washSlide} progress={this.state.wateridprogress} progressTintColor={'#37C6EE'}>
            </ProgressViewIOS>
...
styles = StyleSheet.create({
  ...
  washSlide: {
    ...
    marginLeft: 0,
    marginRight: 0,
    // width:(ScreenWidth - 46*ratio)/5.0,
    height: 10 * ratio,
